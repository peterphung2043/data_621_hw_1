...
|BPMeds|Boolean, does respondent take blood pressure medication|
|prevalentStroke|Boolean, strokes prevalent in family history|
|prevalentHyp|Boolean, hypertension prevalent in family history|
|diabetes|Does respondent have diabetes?|
|totChol|Cholesterol level of respondent|
|sysBP|systolic blood pressure (mmHg)|
|diaBP|diastolic blood pressure (mmHg)|
|BMI|BodyMass Index calculated as: Weight (kg) / Height(meter-squared)|
|heartRate|Beats/Min (Ventricular)|
|glucose|total glucose mg/dL|
|TenYearCHD|Boolean, patient has 10 year risk of future heart disease|
"
