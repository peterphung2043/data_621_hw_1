...
```{r Convert some columns to factor, echo = FALSE}
...
```{r Convert some columns to factor for orignial data, echo = FALSE}
heart_history_original <- heart_history %>%
    mutate(
    Sex = as.factor(Sex),
    education = as.factor(education),
...
```{r, echo = FALSE, results = 'hide', fig.keep = 'all', message = FALSE, fig.show = "hide"}
