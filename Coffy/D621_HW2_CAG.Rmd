...
$$Specificity = \frac{119}{119 + 5} = `r round((specif_score), 4)`$$

The **specificity** rate of the predictions reads as `r round((specif_score*100), 4)`% for the given data and observations.
...
$$F = \frac{2 \times 0.84 \times 0.47}{0.84 \times 0.47} = `r round(((fscore_score)), 4)`$$


The positive class F1-score of the predictions reads as `r round(((fscore_score)*100), 4)`% for the given data and observations. An F1-score in the range of 0.5 - 0.8 is considered a good performance measure for a classification model to predict each observation correctly. 
