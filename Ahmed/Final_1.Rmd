...
---
```{r echo = FALSE, setup, knitr::all_labels(), echo=TRUE, results='hide', warning=FALSE, message=FALSE }
...
raw_data<- as.data.frame(read.csv('moneyball-training-data.csv'))
```
...
```{r scatter per variable echo = FALSE}
