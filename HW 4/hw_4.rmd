...
```{r}
lin_reg_original_vars <- lm(formula = TARGET_AMT ~ . - TARGET_FLAG, data = original_train)
...
step_aic_lin_reg_original_vars_predictions <- predict.glm(step_aic_lin_reg_original_vars, original_test, type = "response")
```